                            ...
                            {paginatedMsps.map((org) => (
                                ...
                                >
                                    <div className="flex flex-col gap-3">
                                        ...
                                        <div>
                                            <p className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">MEMBER ID</p>
                                            <p className="text-sm sm:text-base text-gray-900 dark:text-white truncate">{org.membershipId}</p>
                                        </div>
                                        <div>
                                            <p className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">Name</p>
                                            <p className="text-sm sm:text-base text-gray-900 dark:text-white truncate" style={{ textTransform: 'uppercase' }}>{org.memberName}</p>
                                        </div>
                                        <div>
                    ...
                    <div className="fixed inset-0 bg-transparent flex items-center justify-center z-50 p-2 sm:p-4">
                        <div className="bg-white dark:bg-gray-800 rounded-lg p-3 sm:p-6 shadow-xl border border-gray-200 dark:border-gray-700 w-[calc(100%-1rem)] sm:w-full max-w-full sm:max-w-md max-h-[80vh] overflow-y-auto">
                            ...
                            <div className="space-y-3 sm:space-y-4">
                                ...
                                <div>
                                    <p className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">MEMBER ID</p>
                                    <p className="text-sm sm:text-base text-gray-900 dark:text-white">{viewingOrg.membershipId}</p>
                                </div>
                                <div>
                                    <p className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">Name</p>
                                    <p className="text-sm sm:text-base text-gray-900 dark:text-white" style={{ textTransform: 'uppercase' }}>{viewingOrg.memberName}</p>
                                </div>
                                <div>
                                    <p className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">Location</p>
